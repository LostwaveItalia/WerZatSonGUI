...
if ($Language -ne "italian") { $Language = "english" }
...
$Strings = @{
    ...
    italian = @{
        ...
        BootstrappingPip             = "Bootstrap di pip tramite get_pip.py in corso..."
        PipAvailable                 = "pip è disponibile."
        PipNotAvailable              = "pip non sembra ancora essere disponibile dopo il bootstrap. Le installazioni delle dipendenze Python potrebbero fallire."
